...
const $xbutton = $(".btn btn-outline-warning")
...
const loadList = ()=>{
  history.forEach((element,index)=>{
      ...
      .then ((data)=>{
        ...
        $li.html(`<button id=${historyId} class="btn btn-outline-warning" onclick="remove($('#${historyId}'))"> X </button>
